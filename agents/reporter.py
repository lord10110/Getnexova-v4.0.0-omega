...
class ReporterAgent:
    ...
    async def _generate_ai_content(
        ...
        """Use AI to generate professional report narrative."""
        findings_dicts = [
            {
                "severity": f.severity,
...
<body>
    ...
    <div class="container">
        <div class="summary-grid">
            ...
            <div class="summary-card">
                <div class="count" style="color: #2563eb;">{sum(1 for f in findings if f.severity == 'low')}</div>
                <div>Low</div>
            </div>
        </div>
        <h2>Findings</h2>
    ...
    <div class="footer">
        Generated by GetNexova v4.0.0 OMEGA | {datetime.now(timezone.utc).strftime('%Y-%m-%d')}
    </div>
</body>
</html>"""
